...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Okt 17. 22:59
...
(
    ...
    `nev`     varchar(30)      NOT NULL DEFAULT '',
...
INSERT INTO `helyszin` (`id`, `nev`, `megyeid`)
VALUES (1, 'Várpalota', 14),
       (2, 'Kulcs', 13),
       (3, 'Mosonszolnok', 15),
...
(
    `id`    int(10) UNSIGNED NOT NULL,
    `nev`   varchar(30)      NOT NULL DEFAULT '',
    `regio` varchar(20)      NOT NULL DEFAULT ''
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8;
...
INSERT INTO `megye` (`id`, `nev`, `regio`)
VALUES (1, 'Borsod-Abaúj-Zemplén', 'Észak-Magyarország '),
...
INSERT INTO `torony` (`id`, `darab`, `teljesitmeny`, `kezdev`, `helyszinid`)
VALUES (1, 1, 250, 2000, 1),
       (2, 1, 600, 2001, 2),
       (3, 2, 600, 2002, 3),
       (4, 2, 600, 2003, 4),
       (5, 1, 225, 2005, 5),
