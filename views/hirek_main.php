                ...
                <div class="list-group">
                    <ul class="list-group-item list-group-item-action"
                        ...
                        <form style="max-width: 600px; margin-left:auto; margin-right: auto; margin-top:  20px"
                              action="<?php SITE_ROOT ?>kommentel" method="post">
        ...
        <div class="list-group" style=" margin-top: 50px;">
            ...
            <form action="<?php SITE_ROOT ?>hirbekuld" method="post">
                <li style="max-width: 600px; margin-left:auto; margin-right: auto; margin-top:  40px; list-style-type: none;">
                    <textarea name="ujhir"
                              style="width: 100%; height: 150px; padding: 12px 20px; box-sizing: border-box; border: 2px solid #ccc; border-radius: 4px; background-color: #f8f8f8; font-size: 16px; resize: none;">Ide írja a hírt...</textarea>
                </li>
