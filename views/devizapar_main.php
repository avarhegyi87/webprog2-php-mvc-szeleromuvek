...
<body>
    ...
    <select id = "center" name="penznem" required="required" >
      <option value=" ">Válasszon Devizát!</option>
        ...
        <option value="<?php echo ($curr[$i][0]) -> __toString();?>" ><?php echo ($curr[$i][0]) -> __toString(); }?></option> 
    </select>
    <select id = "center" name="penznem2" required="required">
      <option value=" ">Válasszon Devizát!</option>
        ...
        <option value="<?php echo ($curr1[$i][0]) -> __toString();?>" ><?php echo ($curr1[$i][0]) -> __toString(); }?></option> 
    </select>
        ...
        <h4><?php if(isset($_POST["kuld"]) && $foo != 0) {echo $foo;} 
                 if($er==1){echo $error;}?></h4>

        <button id="Button" class="float-left submit-button" >Főoldal</button>
